...
typedef int8_t offset_s; /* short offset */
typedef int16_t offset_l; /* long offset */
...
#define EMUL_PIN_VDA 0x1
#define EMUL_PIN_VPA 0x2
#define EMUL_PIN_VP  0x4
#define M_READ(a)         MEM_readMem(a, cpu_cycle_count, EMUL_PIN_VDA)
#define M_READ_OPCODE(a)  MEM_readMem(a, cpu_cycle_count, EMUL_PIN_VDA | EMUL_PIN_VPA)
#define M_READ_OPERAND(a) MEM_readMem(a, cpu_cycle_count, EMUL_PIN_VPA)

/* FIXME: maybe EMUL_PIN_VPA is not actually set ? */
#define M_READ_VECTOR(a)  MEM_readMem(a, cpu_cycle_count, EMUL_PIN_VP | EMUL_PIN_VPA)
